package com.dscfast.sawari.services
...
/**
 * code taken from this following github repo:
...
class ForegroundOnlyLocationService : Service() {
    ...
    private fun generateNotification(location: Location?): Notification {
        ...
        val titleText = getString(com.dscfast.sawari.R.string.app_name)
        ...
        val launchActivityIntent = Intent(this, AppActivity::class.java)
    ...
    internal object SharedPreferenceUtil {
        ...
        fun saveLocationTrackingPref(context: Context, requestingLocationUpdates: Boolean) =
            context.getSharedPreferences(SP_FILE, Context.MODE_PRIVATE).edit {
    ...
    companion object {
        ...
        private const val SP_FILE = "locationSharedPrefs"

        private const val PACKAGE_NAME = "com.dscfast.sawari"
